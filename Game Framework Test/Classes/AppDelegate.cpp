...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    // Here you define designSize – the size you’re using when creating your game logic – and resourceSize – the size on which all your art assets are based.
    Size designSize = Size(480,320);
    Size resourceSize = Size(960,640);

    // These lines tell your game’s Director to scale the assets as necessary based on the design and resource sizes you provided.
